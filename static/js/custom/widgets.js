...
//                                     console.log('Data yang akan diupdate:', { categories, bbmData, nonBBMData });  // Tambahkan ini
...
//                                     });
//                                 })
//                                 .catch(error => console.error('Error:', error));  // Tambahkan ini
...
//             // document.addEventListener('DOMContentLoaded', initBBMChart);
